 ...
 */
export declare abstract class NavController implements NavigationContainer {
    ...
    abstract insertPages(insertIndex: number, insertPages: Array<{
        page: Page | string;
        params?: any;
    }>, opts?: NavOptions, done?: TransitionDoneFn): Promise<any>;
    /**
     ...
     * @returns {Promise} Returns a promise which is resolved when the transition has completed.
     */
    abstract setPages(pages: ({
        page: Page | string;
        params?: any;
    } | ViewController)[], opts?: NavOptions, done?: TransitionDoneFn): Promise<any>;
    /**
